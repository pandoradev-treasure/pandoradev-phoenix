        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                            ...
                            <?php
                                ...
                                if (shell_exec('git pull origin featured/yuz') !== "Already up to date.") {
                            ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Update PandoraSetup!
                                                [Versi Terbaru]</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="" method="POST">
                                                <button name="cek-update" class="btn btn-outline-primary btn-sm float-right">Update</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
            ...
            <?php
                ...
                function ExecuteShell()
                {
                    ...
                    shell_exec('git pull origin featured/yuz');
